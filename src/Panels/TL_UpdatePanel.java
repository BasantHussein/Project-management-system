 ...
 */
public class TL_UpdatePanel extends javax.swing.JPanel {

    /**
     * Creates new form Prof_AddPanel
     */
    public TL_UpdatePanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelSucessOrFail.setText("Write TL  ID to get all info ... !       before Update or Delete ... !");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!jTextFieldID.getText().equals("") && !jTextFieldFname.getText().equals("") && !jTextFieldUserName.getText().equals("") && !jPasswordField1.getText().equals("") && !jPasswordField2.getText().equals("") && !jTextFieldAge.getText().equals("") && !jTextFieldSalary.getText().equals("")) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            TeamLeader x = new TeamLeader();
            TeamLeader returned = x.searchLeader(Integer.parseInt(jTextFieldSearchKey.getText()));
            if (returned.getID() > 0) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            TeamLeader x = new TeamLeader();
            if (x.deleteLeader(Integer.parseInt(jTextFieldSearchKey.getText()))) {
    ...
    protected void setPanelData(TeamLeader x) {
