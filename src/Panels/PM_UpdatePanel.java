 ...
 * @author Omar Qabeel 
 */
public class PM_UpdatePanel extends javax.swing.JPanel {

    /**
     * Creates new form Prof_AddPanel
     */
    public PM_UpdatePanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelSucessOrFail.setText("Write PM  ID to get all info ... !       before Update or Delete ... !");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            ProjectManager x = new ProjectManager();
            ProjectManager returned = x.searchPM(Integer.parseInt(jTextFieldSearchKey.getText()));
            if (returned.getID() > 0) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            ProjectManager x = new ProjectManager();
            if (x.deletePM(Integer.parseInt(jTextFieldSearchKey.getText()))) {
    ...
    protected void setPanelData(ProjectManager x) {
