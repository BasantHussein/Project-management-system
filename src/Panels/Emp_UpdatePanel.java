...
public class Emp_UpdatePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelSucessOrFail.setText("Write Employee  ID to get all info ... !       before Update or Delete ... !");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            Employee x = new Employee();
            Employee returned = x.searchEmployee(Integer.parseInt(jTextFieldSearchKey.getText()));
            if (returned.getID() > 0) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (!jTextFieldSearchKey.getText().equals("")) {
            Employee x = new Employee();
            if (x.deleteEmployee(Integer.parseInt(jTextFieldSearchKey.getText()))) {
